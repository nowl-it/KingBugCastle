...
STEEL = 0
steel_ab = [("BaseDef", pair(18, 18.0)[0]), ("BaseMDef", pair(18, 18.0)[1])]
...
COVENANT = 7
covenant_sc = [("BaseMCriticalDamageMul", pair(22, 22.0)[0]), ("BaseMCriticalProb", pair(22, 22.0)[1])]
...
MOONLIGHT = 9
moonlight_ab = [("BaseCriticalDamageMul", pair(18, 18.0)[0]), ("BaseCriticalProb", pair(18, 18.0)[1])]
...
asc_rings_subs = [("BaseDefDen", pair(18, 18.0)[0]), ("BaseMCriticalProb", pair(18, 18.0)[1])]
for i in range(1, 3):
